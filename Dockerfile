...
#RUN echo "deb http://packages.icinga.org/ubuntu icinga-wheezy-snapshots main" >> /etc/apt/sources.list
RUN echo "deb http://ppa.launchpad.net/formorer/icinga/ubuntu trusty main" >> /etc/apt/sources.list && apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 0x4A132479423673E80ACCA85420EEDAFD36862847
